...
impl TimeManager {
    ...
    pub fn deepen(
        ...
        let score_stability = Params::score_stability(score_stability);
        ...
        let new_target = ((base_time as u128 * duck_stability * move_stability * score_stability)
            / 4096u128.pow(2)) as u64;
