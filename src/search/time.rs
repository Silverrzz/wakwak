...
impl TimeManager {
    ...
    pub fn deepen(
        ...
        let waddle_stability = Params::waddle_stability(waddle_stability);
        ...
        let new_target = ((base_time as u128 * duck_stability * move_stability * waddle_stability)
